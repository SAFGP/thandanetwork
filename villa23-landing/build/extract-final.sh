#!/bin/bash
# Make Cameron's snippet edit (master4k-final.mp4, the linear select with the
# 4>5 table fix) the scroll hero: extract it into the numbered WebP sequence
# (desktop 2560px, mobile 1280px). ~273 frames to match the engine's stop math.
set -e
